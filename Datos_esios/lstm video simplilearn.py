...
# # Training set
# for i in range(60, 1258): # len(X_train) = 1258 - 60 = 1198
...
# # Validation set
# for i in range(1258, 1258+250): # len(X_train) = 1258 - 60 = 1198
#     X_val.append(scaled_set[i-60:i, 0])
...
# # Test set
# for i in range(1258+250, 1258+250+250): # len(X_train) = 1258 - 60 = 1198
